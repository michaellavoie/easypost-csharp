...
#pragma warning restore IDE1006 // Naming Styles
        ...
        public void GetRates(Client client) {
            ...
            rates = request.Execute<Order>(client).rates;
        }

        private static Order SendCreate(Client client, Dictionary<string, object> parameters) {
            Request request = new Request("v2/orders", Method.POST);
            request.AddBody(new Dictionary<string, object>() { { "order", parameters } });
        ...
        public void Buy(Client client, string carrier, string service) {
            ...
            Merge(request.Execute<Order>(client));
        }
